...
class StringProcessorTest {
    ...
    void calculateExpression(){
        StringProcessor processor = new StringProcessor();
        assertEquals(-12.0, processor.calculateExpression("3 + 5 * ( 2 - 8 ) / 2"));
        assertEquals(10, processor.calculateExpression("5 + 5"));
        assertEquals(25, processor.calculateExpression("5 * 5"));
        assertEquals(232, processor.calculateExpression("150 + 150 - 68"));
        assertEquals(0, processor.calculateExpression("0 / 10"));
